...
Contract used by :mod:`infergrid._bench.hero`:
...
def ensure_pod(
    *, console: Console, delete_on_exit: bool, port: int = 8000
    ...
    try:
        ...
        _bail(console, "`pip install runpod` required for --pod (not a core infergrid dep).")
